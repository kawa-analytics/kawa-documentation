...
The easiest way is to use them like an Excel Workbook, adding multiple views (Tabs) to explore and visualize your data: [The Visualization section](04_00_visualization.md).
...
The main data source of a Sheet ([Data Integration](01_00_data_integration.md) for details about data sources) will dictate the sheet data granularity. In other words, it will define the primary keys of your sheet.
...
A Sheet contains views that offer diverse perspectives on its data. You can read more about this in the [The Visualization section](04_00_visualization.md).
