...
<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)5.png" alt=""></div>
...
> You can read more about this in the [The Reports section](../05_00_publishing/05_01_reports.md#id-4.-doc).
...
<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)6.png" alt=""></div>

* **Block handle** (six dots) with context menu: Convert to, Move up/Move down, Delete.

<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)7.png" alt=""></div>

* **Add widget** in a Doc: choose a Sheet → Existing or New widget (chart, grid, pivot).

<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)8.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)9.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)10.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)11.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)12.png" alt=""></div>

<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)13.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)14.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/release(1.33)15.png" alt="Release"></div>

![](../.gitbook/assets/release\(1.33\)16.png)
