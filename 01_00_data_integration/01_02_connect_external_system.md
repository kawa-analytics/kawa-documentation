...
![external\_system](../.gitbook/assets/connectors1.png)
...
![external\_system](../.gitbook/assets/connectors2.png)
...
![external\_system](../.gitbook/assets/connectors3.png)

The JSON key must be similar to this:

![external\_system](../.gitbook/assets/connectors4.png)

Your service account key can be found on your Google Cloud Platform console, in the IAM section.

![external\_system](../.gitbook/assets/connectors5.png)
...
![external\_system](../.gitbook/assets/connectors6.png)

Click on "Test Connection" then "Create".

![external\_system](../.gitbook/assets/connectors7.png)
...
![external\_system](../.gitbook/assets/connectors8.png)

* _Step 2:_ Configure your access token as follows

![external\_system](../.gitbook/assets/connectors9.png)

* _Step 3:_ Copy your token

![external\_system](../.gitbook/assets/connectors10.png)
...
![external\_system](../.gitbook/assets/connectors11.png)

Click on "Test Connection" then "Create".

![external\_system](../.gitbook/assets/connectors12.png)
...
![external\_system](../.gitbook/assets/connectors13.png)

![external\_system](../.gitbook/assets/connectors14.png)
...
![external\_system](../.gitbook/assets/connectors15.png)
...
![external\_system](../.gitbook/assets/connectors16.png)

Click on "Test Connection" then "Create".

You can import data either by picking a database and a table or by writing your own query.

![external\_system](../.gitbook/assets/connectors17.png)
...
![external\_system](../.gitbook/assets/connectors18.png)
...
![external\_system](../.gitbook/assets/connectors19.png)
...
![external\_system](../.gitbook/assets/connectors20.png)
...
![external\_system](../.gitbook/assets/connectors21.png)
