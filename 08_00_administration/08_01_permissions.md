...
![Login page](../.gitbook/assets/datasource_types.png)
...
Each workspace functions as a separate isolated tenant. See definitions in [Terminology](../13_00_terminology/) section.
...
![Manage Workspace on the UI](../.gitbook/assets/manage_workspace_permissions.png)
...
Within each workspace, users can be grouped in Teams. See definitions in [Terminology](../13_00_terminology/) section. Teams can be used to share entities with user groups, such as applications, dashboards, sheets and data sources.

Teams are configured on the GUI, from the settings menu.

![Manage teams](../.gitbook/assets/team-configuration.png)
...
![team admin](../.gitbook/assets/team_admin.png)
...
![sheet](../.gitbook/assets/sharing_button.png)

![sheet](../.gitbook/assets/share_sheet.png)
...
![sheet model](../.gitbook/assets/sheet_model.png)
...
![Restricted Provider](../.gitbook/assets/restricted_provider.png)
...
![Publish Dashboard](../.gitbook/assets/publish_dashboard.png)
...
![Impact](../.gitbook/assets/impact.png)
...
![Publish App](../.gitbook/assets/share_app.png)
...
![Impact](../.gitbook/assets/impact_w.png)
