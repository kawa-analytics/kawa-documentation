...
In addition to proposing a Python SDK (`kywy`) to interact with your data in Python, KAWA also comes in with its own Python runtimes. These runtimes can be deployed in your infrastructure and scaled out to fit your use cases and load. See definitions in [Terminology](../13_00_terminology.md#python-tool) section.
...
<div data-with-frame="true"><img src="../.gitbook/assets/python_status.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/vcs1.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/vcs2.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/vcs3.png" alt=""></div>

_On Github, it can be found in the code section, SSH tab:_

<div data-with-frame="true"><img src="../.gitbook/assets/vcs4.png" alt=""></div>

_On Bitbucket, in the Clone section, (do not copy the `ssh://`):_

<div data-with-frame="true"><img src="../.gitbook/assets/vcs5.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/scripts1.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/scripts2.png" alt=""></div>

Type in the content of your script and click on save.

<div data-with-frame="true"><img src="../.gitbook/assets/scripts3.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/scripts4.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/scripts5.png" alt=""></div>
