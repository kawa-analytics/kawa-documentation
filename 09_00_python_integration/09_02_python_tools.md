...
In addition to proposing a Python SDK (`kywy`) to interact with your data in Python, KAWA also comes in with its own Python runtimes. These runtimes can be deployed in your infrastructure and scaled out to fit your use cases and load. See definitions in [Terminology](../13_00_terminology/) section.
...
![Python Status](../.gitbook/assets/python_status.png)
...
![VCS](../.gitbook/assets/scripts1.png)
...
![Tools](../.gitbook/assets/scripts2.png)

Type in the content of your script and click on save.

![Tools](../.gitbook/assets/scripts3.png)
...
![Tools](../.gitbook/assets/scripts4.png)
...
![Tools](../.gitbook/assets/scripts5.png)
