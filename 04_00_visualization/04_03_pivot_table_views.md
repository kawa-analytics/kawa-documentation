...
<div data-with-frame="true"><img src="../.gitbook/assets/pivot_view1.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/pivot_view2.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/pivot_view3.png" alt=""></div>
...
This is the same documented here (Similar as the one available in the Chart Views): [Configure chart series](04_02_chart_views.md#id-2.1.3-value-calculation-show-as)
...
<div data-with-frame="true"><img src="../.gitbook/assets/pivot_view4.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/pivot_view5.png" alt=""></div>
...
You can configure conditional formatting in Pivot tables in a similar way that you would in Grid views. In the pivot tables, there is no notion of Row Data, so you can only work on conditions operating at the group level. Please refer to this [Conditional Formatting](04_01_grid_views.md#a.-conditional-formatting).

Both rule based and gradient formatting are available in the pivot tables.

<div data-with-frame="true"><img src="../.gitbook/assets/pivot_view6.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/pivot_view7.png" alt=""></div>

#### 4.3.2 What it does

* **Top** — the metric name is above the dimension headers.

<div data-with-frame="true"><img src="../.gitbook/assets/pivot_view8.png" alt=""></div>

* **Bottom** — the metric name is below the dimension headers.

<div data-with-frame="true"><img src="../.gitbook/assets/pivot_view9.png" alt=""></div>
...
<div data-with-frame="true"><img src="../.gitbook/assets/pivot_view10.png" alt=""></div>
