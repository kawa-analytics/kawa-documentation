...
> **Fields:** Each column of the grid is called a _field_. See definitions in [Terminology](../13_00_terminology/) section. They are connected to your data and each one can be configured independently from the others. Note that you can connect many fields to the same data, if you want to show it in multiple ways in the same grid.

* TOC {:toc}

In order to create a new Grid View, click on the plus button at the top left of your sheet, and pick: Grid.

![Create grid](../.gitbook/assets/grid_view_create.png)
...
![Hide fields](../.gitbook/assets/grid_view_hide_fields.png)
...
![Add fields](../.gitbook/assets/grid_view_add_fields.png)
...
![Move fields](../.gitbook/assets/grid_view_move_fields.png)
...
![Format fields](../.gitbook/assets/grid_view_rule_formatting.png)
...
![Format fields](../.gitbook/assets/grid_view_color_scale.png)
...
![Format fields](../.gitbook/assets/grid_view_manage_rules.png)
...
![Grouping](../.gitbook/assets/grid_view_grouping1.png)
...
![Grouping](../.gitbook/assets/grid_view_grouping2.png)
...
![Grouping](../.gitbook/assets/grid_view_grouping3.png)
...
![Grouping](../.gitbook/assets/grid_view_grouping4.png)
...
![Linked view](../.gitbook/assets/linked_view.png)
