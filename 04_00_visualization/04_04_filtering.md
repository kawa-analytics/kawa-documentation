...
Filters can be applied to all types of view through the same filter panel. KAWA comes with powerful built-in filters, adapted to all your data types: text, number, booleans, date, date time. See definitions in [Terminology](../13_00_terminology/) section.
...
![Filters](../.gitbook/assets/filters1.png)
...
![Filters](../.gitbook/assets/filters2.png)
...
![Filters](../.gitbook/assets/filter_text1.png)
...
![Filters](../.gitbook/assets/filter_text2.png)
...
![Filters](../.gitbook/assets/filter_number1.png)
